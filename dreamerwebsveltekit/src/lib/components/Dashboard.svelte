...
<nav class="flex border-b border-gray-200 bg-white" aria-label="Breadcrumb">
    <ol role="list" class="flex px-4 sm:px-48 md:px-48 lg:px-48">
        <li class="flex">
        ...
        <div class="flex items-center">
            ...
            <a href="/" class="ml-4 text-sm font-medium text-gray-500 hover:text-gray-700" aria-current="page">Projects</a>
        </div>
        </li>
        <li class="flex">
        <div class="flex items-center">
...
<div>
    ...
    <div id="user-menu-button-mobile" class="relative z-40 md:hidden" role="dialog" aria-modal="true">
        <!--
            ...
            <div class="relative flex w-full max-w-xs flex-1 flex-col bg-gray-800">
                <!--
                  ...
                  Leaving: "ease-in-out duration-300"
                    ...
                    To: "opacity-0"
                -->
                <div id="user-menu-button-none-mobile" class="absolute top-0 right-0 -mr-12 pt-2">
                ...
                <div class="h-0 flex-1 overflow-y-auto pt-5 pb-4">
                    ...
                    <nav class="mt-5 space-y-1 px-2">
                        ...
                        <a href="/Voting" class="text-gray-300 hover:bg-gray-700 hover:text-white group flex items-center px-2 py-2 text-base font-medium rounded-md">
                        ...
                        <a href="/Execution" class="text-gray-300 hover:bg-gray-700 hover:text-white group flex items-center px-2 py-2 text-base font-medium rounded-md">
                        ...
                        <a href="/Discuss" class="text-gray-300 hover:bg-gray-700 hover:text-white group flex items-center px-2 py-2 text-base font-medium rounded-md">
                        ...
                        <a href="/Users" class="text-gray-300 hover:bg-gray-700 hover:text-white group flex items-center px-2 py-2 text-base font-medium rounded-md">
                            <!-- Heroicon name: outline/calendar -->
                            <svg class="text-gray-400 group-hover:text-gray-300 mr-4 flex-shrink-0 h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M15 19.128a9.38 9.38 0 002.625.372 9.337 9.337 0 004.121-.952 4.125 4.125 0 00-7.533-2.493M15 19.128v-.003c0-1.113-.285-2.16-.786-3.07M15 19.128v.106A12.318 12.318 0 018.624 21c-2.331 0-4.512-.645-6.374-1.766l-.001-.109a6.375 6.375 0 0111.964-3.07M12 6.375a3.375 3.375 0 11-6.75 0 3.375 3.375 0 016.75 0zm8.25 2.25a2.625 2.625 0 11-5.25 0 2.625 2.625 0 015.25 0z" />
                            </svg>
    ...
    <div class="hidden md:fixed md:inset-y-0 md:flex w-36 flex-col">
        ...
        <div class="flex min-h-0 flex-1 flex-col bg-gray-800">
            ...
            <div class="flex flex-shrink-0 bg-gray-700 p-4">
                <a href="/Users" class="group block w-full flex-shrink-0">
                    <div class="flex items-center">
                        {#if $currentUser}
                            <div>
