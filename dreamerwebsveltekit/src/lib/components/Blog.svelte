        ...
        <div class="mx-auto mt-12 grid max-w-lg gap-5 lg:max-w-none lg:grid-cols-3">
                ...
                <div class="flex flex-1 flex-col justify-between bg-white p-6">
                    <div class="flex-1">
                        <p class="text-sm font-medium text-indigo-600">
                            <a href="/Blog/Article" class="hover:underline">Article</a>
                        </p>
                        <a href="/Blog/Article" class="mt-2 block">
            ...
            <div class="flex flex-col overflow-hidden rounded-lg shadow-lg">
                ...
                <div class="flex flex-1 flex-col justify-between bg-white p-6">
                    <div class="flex-1">
                        <p class="text-sm font-medium text-indigo-600">
                            <a href="/Blog/Article" class="hover:underline">Video</a>
                        </p>
                        <a href="/Blog/Article" class="mt-2 block">
            ...
            <div class="flex flex-col overflow-hidden rounded-lg shadow-lg">
                ...
                <div class="flex flex-1 flex-col justify-between bg-white p-6">
                    <div class="flex-1">
                        <p class="text-sm font-medium text-indigo-600">
                            <a href="/Blog/Article" class="hover:underline">Case Study</a>
                        </p>
                        <a href="/Blog/Article" class="mt-2 block">
