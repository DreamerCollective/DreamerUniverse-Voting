                ...
                <div class="grid flex-auto grid-cols-1 grid-rows-1">
                    ...
                    <ol class="col-start-1 col-end-2 row-start-1 grid grid-cols-1" style="grid-template-rows: 1.75rem repeat(288, minmax(0, 1fr)) auto">
                        <li class="relative mt-px flex" style="grid-row: 74 / span 12">
                            <a href="/dreamerwebsveltekit/static" class="group absolute inset-1 flex flex-col overflow-y-auto rounded-lg bg-blue-50 p-2 text-xs leading-5 hover:bg-blue-100">
                        ...
                        <li class="relative mt-px flex" style="grid-row: 92 / span 30">
                            <a href="/dreamerwebsveltekit/static" class="group absolute inset-1 flex flex-col overflow-y-auto rounded-lg bg-pink-50 p-2 text-xs leading-5 hover:bg-pink-100">
                        ...
                        <li class="relative mt-px flex" style="grid-row: 134 / span 18">
                            <a href="/dreamerwebsveltekit/static" class="group absolute inset-1 flex flex-col overflow-y-auto rounded-lg bg-indigo-50 p-2 text-xs leading-5 hover:bg-indigo-100">
