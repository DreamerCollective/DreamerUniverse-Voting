        ...
        <div class="pb-16 xl:flex xl:items-center xl:justify-between">
            <div>
                <h1 class="text-4xl font-bold tracking-tight sm:text-5xl">
                    <span class="text-gray-900">Support us for as little as</span>
                    <span class="text-indigo-600">$1 a month</span>
                </h1>
                <p class="mt-5 text-xl text-gray-500">Everything is free anyway but you will be supporting the development of the app.</p>
            </div>
